...
function Strategy(options, verify) {
  ...
  this._fieldField = options.fieldField || 'field';
...
Strategy.prototype.authenticate = function(req, options) {
  ...
  var field = lookup(req.body, this._fieldField) || lookup(req.query, this._fieldField);
  var email = lookup(req.body, this._emailField) || lookup(req.query, this._emailField);
  
  if (!username || !password || !email || !firstName || !lastName || !field) {
  ...
  try {
    if (self._passReqToCallback) {
      this._verify(req, username, password, firstName, lastName, field, email, verified);
    } else {
      this._verify(username, password, firstName, lastName, field, email, verified);
    }
  } catch (ex) {
